...
# Context-Action 스토어 통합 아키텍처 (200자)
...
Context-Action 스토어 통합 아키텍처: Provide comprehensive guidance on concept  architecture guide의 핵심 개념과 Context-Action 프레임워크에서의 역할을 간단히 설명.
```
