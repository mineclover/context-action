...
### 예시 구조
```
Guide  Best Practices: Brief definition with Context-Action framework context
```
...
Best Practices: Provide comprehensive guidance on guide  best practices의 핵심 개념과 Context-Action 프레임워크에서의 역할을 간단히 설명.
```
