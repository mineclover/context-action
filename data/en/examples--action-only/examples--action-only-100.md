...
# Action Only Pattern Example (100자)
...
### 예시 구조
```
Examples  Action Only: Brief definition with Context-Action framework context
```
...
Action Only Pattern Example: Provide comprehensive guidance on examples  action only의 핵심 개념과 Context-Action 프레임워크에서의 역할을 간단히 설명.
```
