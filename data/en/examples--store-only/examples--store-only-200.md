...
# Store Only Pattern Example (200자)
...
Store Only Pattern Example: Provide comprehensive guidance on examples  store only의 핵심 개념과 Context-Action 프레임워크에서의 역할을 간단히 설명.
```
