...
### 예시 구조
```
Guide  Hooks: Brief definition with Context-Action framework context
```
...
React Hooks: Provide comprehensive guidance on guide  hooks의 핵심 개념과 Context-Action 프레임워크에서의 역할을 간단히 설명.
```
