    ...
    <div className="p-4 border rounded-lg bg-green-50">
      ...
      <div className="space-y-3">
        ...
        <div 
          ...
          className="p-4 border-2 border-dashed border-gray-300 rounded text-center min-h-[80px] flex items-center justify-center"
        >
          {interactiveElement.isMounted ? '마운트됨' : '언마운트됨'}
        </div>
