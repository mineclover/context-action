          ...
          <div className="grid gap-3 md:grid-cols-2 text-sm">
            <div>
              ...
              <ul className="mt-1 space-y-1 text-gray-600">
                <li>
                  • <strong>onMount</strong>: 마운트 시 자동 실행
                </li>
                <li>
                  • <strong>executeIfMounted</strong>: 안전한 조건부 실행
                </li>
                <li>
                  • <strong>async/await</strong>: waitForRefs 비동기 처리
                </li>
                <li>
                  • <strong>빈 deps 배열</strong>: 메모이제이션 최적화
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="mt-1 space-y-1 text-gray-600">
                <li>
                  • <strong>busy waiting</strong>: while 루프로 대기
                </li>
                <li>
                  • <strong>동기적 처리</strong>: Promise를 동기적으로 처리
                </li>
                <li>
                  • <strong>불필요한 deps</strong>: ref 객체를 deps에 포함
                </li>
                <li>
                  • <strong>직접 DOM 접근</strong>: target null 체크 없이
                </li>
              </ul>
            </div>
          </div>
