...
// 기본 컨테이너
export const containerVariants = cva('w-full max-w-none', {
  variants: {
    size: {
      sm: 'max-w-2xl',
      md: 'max-w-4xl',
  ...
  'inline-flex items-center justify-center rounded-lg border font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        ...
        success:
          'bg-success-600 text-white border-success-600 hover:bg-success-700 focus:ring-success-500',
        warning:
          'bg-warning-600 text-white border-warning-600 hover:bg-warning-700 focus:ring-warning-500',
        danger:
          'bg-danger-600 text-white border-danger-600 hover:bg-danger-700 focus:ring-danger-500',
        info: 'bg-blue-600 text-white border-blue-600 hover:bg-blue-700 focus:ring-blue-500',
        outline:
          'bg-transparent text-gray-700 border-gray-300 hover:bg-gray-50 focus:ring-primary-500',
        ghost:
          'bg-transparent text-gray-700 border-transparent hover:bg-gray-100 focus:ring-primary-500',
      },
      size: {
...
export const toastVariants = (
  props?: VariantProps<typeof _toastVariants>
): string => {
...
// 로그 모니터 컴포넌트
export const logMonitorVariants = cva('bg-white rounded-lg border shadow-sm', {
  variants: {
    size: {
      sm: 'text-xs',
      md: 'text-sm',
...
>;
export type ToastStepBadgeVariants = VariantProps<
  typeof toastStepBadgeVariants
>;
