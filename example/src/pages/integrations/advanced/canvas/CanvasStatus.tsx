        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg border border-blue-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 text-sm">
            ...
            >
              ...
              <div className="font-medium">
                <span
                  className={canvasFocused ? 'text-green-600' : 'text-gray-400'}
                >
            ...
            >
              ...
              <div
                className={`font-medium capitalize ${currentMode === 'draw' ? 'text-purple-600' : 'text-orange-600'}`}
              >
                {currentMode}
              </div>
            </div>
            ...
            >
              ...
              <div className="font-medium">
                <span
                  className={isDragging ? 'text-yellow-600' : 'text-gray-400'}
                >
            ...
            {shapes.length === 0 ? (
              <div className="text-center py-8 text-gray-500 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm">
                  Select a tool from the toolbar above and start drawing!
                </div>
              </div>
            ) : (
                      ...
                      <div className="p-3">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            <span
                              className={`font-medium text-sm capitalize transition-colors ${
                            ...
                            <div className="mt-2 p-2 bg-gray-50 rounded text-xs space-y-1">
                              ...
                              {shape.type !== 'freehand' && (
                                <>
                                  <div>
                                    <strong>Size:</strong>{' '}
                                    {Math.round(shape.width)}w ×{' '}
                                    {Math.round(shape.height)}h
                                  </div>
                                  <div>
                                    <strong>Area:</strong>{' '}
                                    {Math.round(shape.width * shape.height)}px²
                                  </div>
                                </>
                              )}
                            </div>
