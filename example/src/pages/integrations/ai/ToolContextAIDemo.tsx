...
function UIStateManager({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={styles.container} data-theme={uiState.theme}>
      {React.cloneElement(
        children as React.ReactElement<{ uiState: UIState }>,
        { uiState }
      )}
    </div>
  );
          ...
          <div className={styles.messagesSection}>
            ...
            <form onSubmit={handleSendMessage} className={styles.inputForm}>
              ...
              <button
                type="submit"
                disabled={
                  !apiKey || !selectedModel || executing || !input.trim()
                }
          ...
          <div className={styles.stateSection}>
            ...
            <div className={styles.notificationsArea}>
              {uiState.notifications.map(
                (notif: { id: string; message: string; type: string }) => (
                  <div
                    key={notif.id}
