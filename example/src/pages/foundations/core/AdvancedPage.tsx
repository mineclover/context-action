...
function CoreAdvancedDemo() {
  ...
  useSourceLinkRegistration({
    ...
    category: 'core',
    description: 'Advanced ActionRegister features with priority, async, and error handling',
    tags: ['core', 'advanced', 'priority', 'async', 'error-handling', 'actionregister']
  });
    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-start mb-6">
        <div className="flex-1">
          ...
          <p className="text-gray-600">
            우선순위 시스템, 비동기 처리, 에러 핸들링 등 ActionRegister의 고급 기능들을 살펴봅니다.
            각 데모는 독립적인 ActionRegister 인스턴스를 사용하여 서로 격리되어 있습니다.
          </p>
        </div>
      ...
      <div className="mt-12">
        ...
        <p className="text-gray-600 mb-6">
          다양한 패턴과 실제 사용 사례를 통해 ActionRegister의 강력한 기능들을 살펴보세요.
          각 예제는 실무에서 바로 적용 가능한 패턴들입니다.
        </p>
