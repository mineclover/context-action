...
function StoreFullDemoPage() {
  ...
  const getColorClasses = (color: string, isActive: boolean = false) => {
    const colorMap = {
      blue: isActive ? 'bg-blue-500 text-white' : 'bg-blue-50 text-blue-800 border-blue-200 hover:bg-blue-100',
      green: isActive ? 'bg-green-500 text-white' : 'bg-green-50 text-green-800 border-green-200 hover:bg-green-100',
      purple: isActive ? 'bg-purple-500 text-white' : 'bg-purple-50 text-purple-800 border-purple-200 hover:bg-purple-100',
      orange: isActive ? 'bg-orange-500 text-white' : 'bg-orange-50 text-orange-800 border-orange-200 hover:bg-orange-100',
    };
      ...
      <div className="page-container">
        <header className="page-header">
          ...
          <p className="page-description">
            4개의 실제 시나리오를 모듈화하여 구현한 Store 시스템 데모입니다.
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">📋 Store Scenarios</h3>
              <Button
              ...
              {demos.map((demo) => (
                <button
                  ...
                  className={`p-4 rounded-lg border-2 transition-all duration-200 text-left ${
                    getColorClasses(demo.color, activeDemo === demo.id)
                  }`}
                >
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h2 className="text-xl font-bold text-gray-900">{currentDemo?.title}</h2>
                      <p className="text-gray-600 mt-1">{currentDemo?.description}</p>
                    </div>
                    <Badge variant="outline" className={`${getColorClasses(currentDemo?.color || 'blue')}`}>
        ...
        <Card className="mt-6">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">🏗️ Modular Architecture</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <p className="text-sm text-blue-700 mb-2">공통 인터페이스와 액션 타입 정의</p>
                <code className="text-xs bg-blue-100 px-2 py-1 rounded text-blue-800">/types/index.ts</code>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <p className="text-sm text-green-700 mb-2">각 시나리오별 데이터 스토어와 초기값</p>
                <code className="text-xs bg-green-100 px-2 py-1 rounded text-green-800">/stores/index.ts</code>
              </div>
              ...
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                ...
                <p className="text-sm text-purple-700 mb-2">비즈니스 로직과 액션 핸들러</p>
                <code className="text-xs bg-purple-100 px-2 py-1 rounded text-purple-800">/actions/index.ts</code>
              </div>
              ...
              <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                ...
                <p className="text-sm text-orange-700 mb-2">재사용 가능한 UI 컴포넌트들</p>
                <code className="text-xs bg-orange-100 px-2 py-1 rounded text-orange-800">/components/*.tsx</code>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mt-6">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">📚 Store Management Patterns Overview</h3>
              ...
              {demos.map((demo, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium">{index + 1}. {demo.title}</h4>
                      <p className="text-sm opacity-80 mt-1">{demo.description}</p>
                    </div>
                    {activeDemo === demo.id && (
                      <Badge variant="outline" className="bg-white/20 text-current border-current/20">
                        Currently Viewing
                      </Badge>
                    )}
                  </div>
        ...
        <Card className="mt-6">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">🔧 Modular Implementation Example</h3>
...
export function UserProfileDemo() {
  ...
  return <div>...</div>;
        ...
        <Card className="mt-6">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">🎯 Modular Architecture Benefits</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <p className="text-sm text-blue-700">각 모듈을 독립적으로 재사용하고 테스트할 수 있습니다.</p>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <p className="text-sm text-green-700">분리된 로직으로 단위 테스트가 쉬워집니다.</p>
              </div>
              ...
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                ...
                <p className="text-sm text-purple-700">타입, 데이터, 로직, UI가 명확히 분리되어 있습니다.</p>
              </div>
              ...
              <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                ...
                <p className="text-sm text-orange-700">각 모듈의 책임이 명확해 수정과 확장이 용이합니다.</p>
              </div>
            </div>
          </CardContent>
        </Card>
