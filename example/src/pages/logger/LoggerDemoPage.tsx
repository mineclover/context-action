...
// 로그 레벨 선택 컴포넌트
function LogLevelSelector({ level, onChange }: { level: LogLevel; onChange: (level: LogLevel) => void }) {
  return (
    <div className="log-level-selector">
      <label>Log Level:</label>
      <select value={level} onChange={(e) => onChange(Number(e.target.value))} className="select-input">
