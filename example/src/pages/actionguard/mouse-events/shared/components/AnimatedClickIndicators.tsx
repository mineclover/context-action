...
const AnimatedClickIndicatorsComponent = ({
  clickHistory,
}: AnimatedClickIndicatorsProps) => {
...
export const AnimatedClickIndicators = memo(
  AnimatedClickIndicatorsComponent,
  (prevProps, nextProps) => {
    return (
      prevProps.clickHistory.length === nextProps.clickHistory.length &&
      (prevProps.clickHistory.length === 0 ||
        prevProps.clickHistory[0]?.timestamp ===
          nextProps.clickHistory[0]?.timestamp)
    );
  }
);
