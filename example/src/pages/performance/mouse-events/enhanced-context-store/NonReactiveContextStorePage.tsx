...
export const useNonReactiveMouseEventsLogic = () => {
  ...
  return { handleMove, handleClick };
              ...
              <div className="bg-white/70 rounded-xl border border-purple-200 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 rounded-lg border border-purple-200">
                    <h4 className="font-semibold text-purple-700 mb-3">🔔 Reactive Pattern</h4>
                    <ul className="space-y-2 text-sm text-purple-600">
                      <li>• <strong>렌더링:</strong> 상태 변경 시 React 리렌더링</li>
                      <li>• <strong>구독:</strong> useStoreValue()로 Store 구독</li>
                      <li>• <strong>업데이트:</strong> useEffect를 통한 DOM 업데이트</li>
                      <li>• <strong>메모리:</strong> React 렌더링 큐에 작업 누적</li>
                      <li>• <strong>복잡도:</strong> 단순하고 예측 가능</li>
                    </ul>
                  </div>
                  <div className="bg-gradient-to-br from-green-50 to-cyan-50 p-4 rounded-lg border border-green-200">
                    <h4 className="font-semibold text-green-700 mb-3">🚀 Non-Reactive Pattern</h4>
                    <ul className="space-y-2 text-sm text-green-600">
                      <li>• <strong>렌더링:</strong> Zero React 리렌더링 보장</li>
                      <li>• <strong>접근:</strong> getValue()로 필요시에만 접근</li>
                      <li>• <strong>업데이트:</strong> RefContext 직접 DOM 조작</li>
                      <li>• <strong>메모리:</strong> 최소한의 메모리 사용</li>
                      <li>• <strong>복잡도:</strong> 수동 상태 동기화 필요</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/70 rounded-xl border border-indigo-200 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-green-700 mb-3">✅ 적합한 경우</h4>
                    <ul className="space-y-2 text-sm text-green-600">
                      <li>• <strong>고빈도 업데이트:</strong> 마우스 이동, 애니메이션</li>
                      <li>• <strong>성능 중심:</strong> 60fps 유지가 중요한 경우</li>
                      <li>• <strong>Canvas/SVG:</strong> 직접적인 그래픽 조작</li>
                      <li>• <strong>실시간 데이터:</strong> 스트리밍 데이터 시각화</li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="font-semibold text-red-700 mb-3">⚠️ 주의사항</h4>
                    <ul className="space-y-2 text-sm text-red-600">
                      <li>• <strong>복잡성 증가:</strong> 수동 상태 동기화 필요</li>
                      <li>• <strong>디버깅 어려움:</strong> React DevTools 추적 불가</li>
                      <li>• <strong>일관성 관리:</strong> Store와 DOM 상태 불일치 위험</li>
                      <li>• <strong>학습 비용:</strong> RefContext 패턴 이해 필요</li>
                    </ul>
                  </div>
                </div>
              </div>
