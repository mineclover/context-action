...
export function VisualizationDashboard({
  ...
  const [selectedMetric, setSelectedMetric] = useState<'position' | 'movement' | 'clicks' | 'activity'>('position');
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/70 rounded-lg p-4 border border-blue-200">
              <h4 className="font-medium text-blue-700 mb-2">Current Position</h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-600">X:</span>
                  <span className="font-mono text-blue-600">{formatNumber(position.x)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Y:</span>
                  <span className="font-mono text-blue-600">{formatNumber(position.y)}</span>
                </div>
                <div className="flex justify-between">
            ...
            {/* Position History */}
            <div className="bg-white/70 rounded-lg p-4 border border-blue-200">
              <h4 className="font-medium text-blue-700 mb-2">Position History</h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-600">Path Points:</span>
                  <span className="font-mono text-blue-600">{movement.path.length}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Coverage:</span>
                  <span className="font-mono text-blue-600">
                    {movement.path.length > 0 ? formatNumber((movement.path.length / 1000) * 100) : '0.00'}%
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-white/70 rounded-lg p-4 border border-blue-200">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-blue-600 text-xs">800×600</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Quadrant:</span>
                  <span className="font-mono text-blue-600">
                    {position.x > 400 ? 'R' : 'L'}{position.y > 300 ? 'B' : 'T'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Center Dist:</span>
                  <span className="font-mono text-blue-600">
                    {formatNumber(Math.sqrt((position.x - 400) ** 2 + (position.y - 300) ** 2))}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/70 rounded-lg p-4 border border-purple-200">
              <h4 className="font-medium text-purple-700 mb-2">Velocity Metrics</h4>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Current:</span>
                  <div className="flex items-center gap-2">
                    <span className={`font-mono font-bold ${getVelocityColor(movement.velocity)}`}>
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`font-mono ${getVelocityColor(activity.averageVelocity)}`}>
                ...
                <div className="flex justify-between">
                  ...
                  <span className={`text-sm font-medium ${movement.isMoving ? 'text-green-600' : 'text-gray-400'}`}>
            ...
            {/* Direction & Path */}
            <div className="bg-white/70 rounded-lg p-4 border border-purple-200">
              <h4 className="font-medium text-purple-700 mb-2">Direction & Path</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-purple-600">
                    {movement.direction >= 315 || movement.direction < 45 ? '⬆️ N' :
                     movement.direction >= 45 && movement.direction < 135 ? '➡️ E' :
                     movement.direction >= 135 && movement.direction < 225 ? '⬇️ S' : '⬅️ W'}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            {/* Movement Quality */}
            <div className="bg-white/70 rounded-lg p-4 border border-purple-200">
              <h4 className="font-medium text-purple-700 mb-2">Movement Quality</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Smoothness:</span>
                  <span className="text-sm font-medium text-green-600">
                    {movement.velocity < 100 ? '🟢 Smooth' : 
                     movement.velocity < 200 ? '🟡 Moderate' : '🔴 Jerky'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Precision:</span>
                  <span className="text-sm font-medium text-blue-600">
                    {activity.totalMoves < 100 ? '🎯 High' :
                     activity.totalMoves < 500 ? '📍 Medium' : '🌊 Fluid'}
                  </span>
                </div>
                <div className="flex justify-between">
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/70 rounded-lg p-4 border border-green-200">
              <h4 className="font-medium text-green-700 mb-2">Click Statistics</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
            ...
            <div className="bg-white/70 rounded-lg p-4 border border-green-200">
              ...
              <div className="space-y-1 max-h-24 overflow-y-auto">
                {clicks.slice(-3).reverse().map((click, index) => (
                  <div key={click.id} className="flex justify-between text-xs">
                    <span className="text-gray-600">
                      {click.type === 'single' ? '🖱️' : 
                       click.type === 'double' ? '🖱️🖱️' : '🖱️➡️'}
                    </span>
                    <span className="font-mono text-green-600">
                      ({formatNumber(click.position.x, 0)}, {formatNumber(click.position.y, 0)})
                    </span>
                  </div>
                ))}
                {clicks.length === 0 && (
        ...
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-6 border border-orange-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/70 rounded-lg p-4 border border-orange-200">
              <h4 className="font-medium text-orange-700 mb-2">Session Overview</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Status:</span>
                  <span className={`text-sm font-medium ${getActivityColor()}`}>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-orange-600 text-xs">
                    {new Date(Date.now() - activity.sessionDuration).toLocaleTimeString()}
                  </span>
                </div>
              </div>
            </div>
            ...
            {/* Activity Metrics */}
            <div className="bg-white/70 rounded-lg p-4 border border-orange-200">
              <h4 className="font-medium text-orange-700 mb-2">Activity Metrics</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
            ...
            {/* Performance Index */}
            <div className="bg-white/70 rounded-lg p-4 border border-orange-200">
              <h4 className="font-medium text-orange-700 mb-2">Performance Index</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Efficiency:</span>
                  <span className="text-sm font-medium text-green-600">
                    {activity.totalClicks / (activity.totalMoves || 1) > 0.1 ? '🎯 High' :
                     activity.totalClicks / (activity.totalMoves || 1) > 0.05 ? '📍 Medium' : '🌊 Exploratory'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Engagement:</span>
                  <span className="text-sm font-medium text-blue-600">
                    {activity.sessionDuration > 30000 ? '🔥 High' :
                     activity.sessionDuration > 10000 ? '👍 Medium' : '👋 Brief'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Interaction:</span>
                  <span className="text-sm font-medium text-purple-600">
                    {(activity.totalMoves + activity.totalClicks) > 100 ? '⚡ Intensive' :
                     (activity.totalMoves + activity.totalClicks) > 20 ? '📊 Moderate' : '🔍 Light'}
                  </span>
                </div>
              </div>
            </div>
