      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-4 text-xs">
          <div className={`px-2 py-1 rounded-full text-xs font-medium ${
            activity.isActive ? 'bg-purple-200 text-purple-800' : 'bg-gray-200 text-gray-600'
          }`}>
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className={`text-center p-6 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-purple-200 transition-all duration-500 ${
            activity.isActive || summary.hasActivity ? 'opacity-30 scale-95' : 'opacity-100 scale-100'
          }`}>
