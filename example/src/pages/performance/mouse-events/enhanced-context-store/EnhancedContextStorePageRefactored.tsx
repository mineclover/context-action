          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
              ...
              <ul className="space-y-2 text-sm text-purple-700">
                <li>
                  • <strong>Store Contexts</strong> with declarative state
                </li>
                <li>
                  • <strong>useStoreValue()</strong> reactive subscriptions
                </li>
                <li>
                  • <strong>Automatic updates</strong> on state changes
                </li>
                <li>
                  • <strong>React integration</strong> with re-render cycle
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-6 border border-pink-200">
              ...
              <ul className="space-y-2 text-sm text-pink-700">
                <li>
                  • <strong>useEffect</strong> for reactive updates
                </li>
                <li>
                  • <strong>Store subscriptions</strong> trigger re-renders
                </li>
                <li>
                  • <strong>useState</strong> for local component state
                </li>
                <li>
                  • <strong>React lifecycle</strong> integration
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-200">
              ...
              <ul className="space-y-2 text-sm text-cyan-700">
                <li>
                  • <strong>React re-renders</strong> on state changes
                </li>
                <li>
                  • <strong>useStoreValue</strong> subscriptions
                </li>
                <li>
                  • <strong>useEffect</strong> for DOM updates
                </li>
                <li>
                  • <strong>Traditional rendering</strong> cycle
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="px-6 mb-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 border border-pink-200 shadow-xl">
          ...
          <div className="mb-4 text-sm text-pink-700">
            Move your mouse and click to see reactive updates with React
            re-renders
          </div>
              ...
              <div className="bg-white p-4 rounded-lg border">
                <div className="space-y-3 text-sm">
                  ...
                  <div className="text-purple-600 text-xs">
                    • useStoreValue() → React re-render
                    <br />• setState() → Virtual DOM diff
                    <br />• useEffect() → DOM updates
                    <br />• Predictable but potentially expensive
                  </div>
                  <div className="font-semibold text-green-700 mt-3">
                    🚀 Non-Reactive Pattern
                  </div>
                  <div className="text-green-600 text-xs">
                    • store.getValue() → No subscription
                    <br />• RefContext → Direct DOM manipulation
                    <br />• Zero React re-renders
                    <br />• Maximum performance but higher complexity
                  </div>
                </div>
              </div>
            </div>
