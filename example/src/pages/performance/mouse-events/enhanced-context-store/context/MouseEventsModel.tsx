...
import { createStoreContext, createActionContext, createRefContext } from '@context-action/react';
 ...
 */
export function MouseEventsModelProvider({ children }: { children: React.ReactNode }) {
  return (
    <MouseStoreProvider>
      <MouseActionProvider>
        <MouseRefProvider>
