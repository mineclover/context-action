      ...
      <div className="page-container">
        <header className="page-header">
          ...
          <p className="page-description">
            ...
            <strong>
              real-time debugging, analytics, and performance monitoring
            </strong>
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mt-4">
            ...
            <ul className="text-sm text-emerald-700 space-y-1">
              ...
              <li>
                • <strong>Real-time Debugger</strong> - Live state inspection
              </li>
              <li>
                • <strong>Advanced Metrics</strong> - Performance analytics
              </li>
              <li>
                • <strong>Selective Subscriptions</strong> - Optimized
                re-renders
              </li>
            </ul>
          </div>
