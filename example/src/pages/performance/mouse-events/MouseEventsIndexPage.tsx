  ...
  const additionalExamples = [
    {
      ...
      features: ['Action handlers', 'Store integration', 'Event-driven', 'Business logic separation'],
      performance: 'Good',
    ...
    },
    {
      ...
      description: 'Advanced RefContext with Canvas API for maximum performance',
      ...
      <div className="page-container">
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <h2 className="text-2xl font-bold text-gray-900">🎯 Core Architecture Patterns</h2>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <h2 className="text-2xl font-bold text-gray-900">🛠️ Specialized Demos</h2>
