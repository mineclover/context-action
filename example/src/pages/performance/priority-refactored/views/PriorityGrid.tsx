/**
 * @fileoverview Priority Grid View Component
 *
 * Context-Driven Architecture의 View Layer
 * 순수 UI 컴포넌트로 우선순위 그리드를 렌더링합니다.
 */

import { memo, useCallback, useEffect, useMemo, useRef, useState } from 'react';
import type { HandlerConfig } from '../contexts/PriorityContexts';
import { usePriorityCountsState } from '../hooks/usePriorityTestState';
...
export const PriorityGrid = memo<PriorityGridProps>(
  ({ configs, className = '', allowManualClick = false }) => {
    const { priorityCounts, priorityCountsStore } = usePriorityCountsState();
