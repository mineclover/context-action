      ...
      <div className="p-4 border-2 border-red-500 bg-red-50 rounded-lg">
        ...
        <div className="space-y-1 text-sm">
          <p className="text-red-600">
            Component <strong>"{componentName}"</strong> was automatically
            unmounted to prevent infinite re-renders.
          </p>
          ...
          <div className="mt-3 p-2 bg-yellow-50 border border-yellow-200 rounded">
            <p className="text-xs text-yellow-800">
              <strong>💡 Tip:</strong> Check for missing dependencies in
              useCallback/useMemo, or handlers being recreated on every render.
            </p>
          </div>
