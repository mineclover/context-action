...
export const processLargeDataSet = (data: number[]): { id: number; value: number; timestamp: number }[] => {
...
// 결과 변환 유틸리티
export const convertToProcessedResults = (result: number[]): { id: number; value: number; timestamp: number }[] => {
