...
interface SearchActions {
  performSearch: { query: string; filters: Record<string, string>; signal?: AbortSignal };
...
const sampleData: SearchItem[] = [
  { id: '1', title: 'React Hooks Advanced Patterns', category: 'Tutorial', tags: ['react', 'hooks', 'javascript', 'patterns'], author: 'John Doe', date: '2024-01-15', popularity: 95 },
  { id: '2', title: 'TypeScript Best Practices Guide', category: 'Guide', tags: ['typescript', 'javascript', 'best-practices', 'coding'], author: 'Jane Smith', date: '2024-01-20', popularity: 88 },
  { id: '3', title: 'Context-Action Framework Deep Dive', category: 'Documentation', tags: ['context-action', 'react', 'state-management', 'framework'], author: 'Dev Team', date: '2024-01-25', popularity: 92 },
  { id: '4', title: 'Performance Optimization Masterclass', category: 'Tutorial', tags: ['performance', 'optimization', 'react', 'javascript'], author: 'Mike Johnson', date: '2024-01-30', popularity: 96 },
  { id: '5', title: 'Action Pipeline Architecture', category: 'Tutorial', tags: ['context-action', 'pipeline', 'advanced', 'architecture'], author: 'Sarah Wilson', date: '2024-02-05', popularity: 89 },
  { id: '6', title: 'Store Management Patterns', category: 'Guide', tags: ['store', 'patterns', 'architecture', 'design'], author: 'Tom Brown', date: '2024-02-10', popularity: 85 },
  { id: '7', title: 'Component Testing Strategies', category: 'Guide', tags: ['testing', 'components', 'jest', 'tdd'], author: 'Lisa Chen', date: '2024-02-15', popularity: 91 },
  { id: '8', title: 'Real-time State Synchronization', category: 'Documentation', tags: ['state', 'sync', 'real-time', 'websockets'], author: 'Alex Kim', date: '2024-02-20', popularity: 87 },
];
    ...
    <section className="bg-white rounded-2xl shadow-xl p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">고급 검색 기능과 abort 가능한 검색 시스템</p>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
            ...
            <div className="space-y-4 text-blue-800">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>Action Pipeline:</strong> performSearch, updateQuery, addSearch, removeSearch, selectResult
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-indigo-500 rounded-full mt-2 flex-shrink-0" />
                <div>
                  <strong>Store Management:</strong> query, filters, results, selectedResult, isSearching, metrics
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0" />
                <div>
                  <strong>Abort Support:</strong> AbortController integration for cancellable search operations
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
            <h3 className="text-xl font-semibold text-green-900 mb-4">⚡ Key Features</h3>
        ...
        <div className="space-y-6">
          <div className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
            <h3 className="text-xl font-semibold text-purple-900 mb-4">🔄 Data Flow</h3>
...
function SearchDemoInterface() {
  ...
  // Action handlers
  useActionHandler('updateQuery', useCallback(async (payload) => {
  ...
  useActionHandler('performSearch', useCallback(async (payload, controller) => {
    ...
    try {
      ...
      const newMetrics: SearchMetrics = {
        ...
        averageSearchTime: ((currentMetrics.averageSearchTime * currentMetrics.totalSearches) + searchTime) / (currentMetrics.totalSearches + 1),
  ...
  useActionHandler('addSearch', useCallback(async (payload) => {
    ...
    dispatch('performSearch', { query: queryStore.getValue(), filters: newSearchs });
  }, [dispatch, filtersStore, queryStore]));

  useActionHandler('removeSearch', useCallback(async (payload) => {
    const currentSearchs = filtersStore.getValue();
  ...
  useActionHandler('clearSearchs', useCallback(async () => {
    filtersStore.setValue({});
    dispatch('performSearch', { query: queryStore.getValue(), filters: {} });
  }, [dispatch, filtersStore, queryStore]));

  useActionHandler('selectResult', useCallback(async (payload) => {
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-green-50 p-4 rounded-lg">
          <div className="text-2xl font-bold text-green-600">{stats.results}</div>
        ...
        <div className="bg-orange-50 p-4 rounded-lg">
          <div className="text-2xl font-bold text-orange-600">{Object.keys(filters).length}</div>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-1">
                {stats.categories.map(category => (
                  <button
                    key={category}
                    onClick={() => dispatch('addSearch', { key: 'category', value: category })}
    ...
    <section className="bg-white rounded-2xl shadow-xl p-8">
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Popular Searches */}
          <div className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
            <h3 className="text-lg font-semibold text-purple-900 mb-4">🔥 인기 검색어</h3>
            <div className="space-y-2">
              ...
              {Object.keys(metrics?.searchHits || {}).length === 0 && (
                <div className="text-sm text-purple-700 italic">검색어가 없습니다</div>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="p-6 bg-gradient-to-r from-orange-50 to-red-50 rounded-xl">
            <h3 className="text-lg font-semibold text-orange-900 mb-4">⚡ 실시간 상태</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="p-6 bg-gray-50 rounded-xl">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">🏪 Store Context Pattern</h3>
...
{`const { Provider, useStore } = createStoreContext('AdvancedSearch', {
  ...
  metrics: {
    ...
    popularSearchs: []
          ...
          <div className="p-6 bg-gray-50 rounded-xl">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">⚡ Action Handler</h3>
            <pre className="text-sm bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
{`useActionHandler('performSearch', useCallback(async (payload, controller) => {
  const startTime = Date.now();
  isSearchingStore.setValue(true);
  ...
  try {
    ...
    isSearchingStore.setValue(false);
        ...
        <div className="space-y-6">
          <div className="p-6 bg-gray-50 rounded-xl">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">🎯 Action Types</h3>
            <pre className="text-sm bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
{`interface SearchActions {
  performSearch: { 
    query: string; 
  ...
  abortSearch: void;
          ...
          <div className="p-6 bg-gray-50 rounded-xl">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">📊 Relevance Scoring</h3>
            <pre className="text-sm bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
