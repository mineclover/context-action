...
export function ActionGuardIndexPageRefactored() {
  const [selectedCategory, setSelectedCategory] = useState<
    'all' | 'core' | 'performance' | 'interaction' | 'api' | 'advanced'
  >('all');
  ...
  const actionGuardDemos: ActionGuardDemo[] = [
    {
      ...
      emoji: '🚀',
      description:
        'Multi-instance priority performance testing with advanced queuing and resource management',
    ...
    },
    {
      ...
      emoji: '🔍',
      description:
        'Intelligent search with debouncing, abort capabilities, and result optimization',
    ...
    },
    {
      ...
      emoji: '📜',
      description:
        'Infinite scrolling with virtualization and optimized rendering performance',
    ...
    },
    {
      ...
      emoji: '🚫',
      description:
        'Advanced API request blocking, deduplication, and intelligent caching system',
    ...
    },
    {
      ...
      emoji: '🖱️',
      description:
        'Advanced mouse event handling with performance optimization and interaction patterns',
    ...
    },
    {
      ...
      emoji: '⚖️',
      description:
        'Comprehensive comparison of different throttling methods and performance analysis',
    ...
    },
    {
      ...
      emoji: '🔄',
      description:
        'All-in-one conditional execution patterns - comprehensive legacy implementation',
      ...
      useCase:
        'Learning conditional execution patterns and legacy system integration',
    ...
    },
    {
      ...
      emoji: '🎯',
      description:
        'Modern pattern-separated conditional execution - environment, feature flags, permissions, business rules',
      ...
      useCase:
        'Modern applications with complex conditional logic requirements',
    ...
    },
    {
      ...
      emoji: '🎛️',
      description:
        'Sophisticated filtering patterns - handler ID, priority, custom logic, and combined filtering',
      ...
      useCase:
        'Complex action management systems requiring fine-grained control',
  ...
  const filteredDemos = useMemo(() => {
    return actionGuardDemos.filter((demo) => {
      ...
      const complexityMatch =
        selectedComplexity === 'all' || demo.complexity === selectedComplexity;
  ...
  const categoryStats = useMemo(() => {
    const stats = actionGuardDemos.reduce(
      (acc, demo) => {
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-8 border border-slate-200 shadow-xl mb-8">
          <header className="mb-8">
            ...
            <p className="text-lg text-slate-600 leading-relaxed max-w-4xl mb-6">
              Comprehensive collection of ActionGuard demonstrations showcasing
              advanced performance optimization, event handling, API management,
              and real-world implementation patterns using the Context-Action
              framework.
            </p>
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <div className="text-slate-500">
                <strong>{filteredDemos.length}</strong> of{' '}
                <strong>{actionGuardDemos.length}</strong> demos showing
              </div>
            </div>
          </header>
            ...
            {filteredDemos.map((demo) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-1">
                        <Badge
                          variant="outline"
                          className={getCategoryColor(demo.category)}
                        >
                          {demo.category}
                        </Badge>
                        <Badge
                          variant="outline"
                          className={getComplexityColor(demo.complexity)}
                        >
                          {demo.complexity}
                        </Badge>
                      </div>
                  ...
                  <Badge
                    variant="outline"
                    className={getPerformanceColor(demo.performanceImpact)}
                  >
                ...
                <div className="mb-4 text-xs text-slate-600">
                  ...
                  <div>
                    <strong>Estimated Time:</strong> {demo.estimatedTime}
                  </div>
                </div>
                ...
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-green-700 text-xs">
                      Intelligent queuing with configurable priorities
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-green-700 text-xs">
                      Multiple throttling strategies with performance analysis
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-blue-700 text-xs">
                      Automatic prevention of duplicate API calls
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-purple-700 text-xs">
                      Environment-based and rule-based execution
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-purple-700 text-xs">
                      Handler ID, priority, and custom logic filtering
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-purple-700 text-xs">
                      Dynamic feature toggling and A/B testing support
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-blue-800">
                      Start with Throttle Comparison
                    </div>
                    <div className="text-blue-700 text-xs">
                      Learn basic performance optimization concepts
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-blue-700 text-xs">
                      Understand interaction optimization patterns
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-blue-700 text-xs">
                      Advanced API optimization and caching
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-green-700 text-xs">
                      Begin with basic demos before advanced patterns
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-green-700 text-xs">
                      Use browser dev tools to track improvements
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-green-700 text-xs">
                      Experiment with extreme scenarios
                    </div>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-green-700 text-xs">
                      Use comparison demos to understand trade-offs
                    </div>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <div className="text-purple-700 text-xs">
                    React DevTools, Performance profiler, Network inspector
                  </div>
                </div>
                <div>
                  <div className="font-semibold text-purple-800 mb-1">
                  ...
                  <div className="text-purple-700 text-xs">
                    Core Web Vitals, FPS monitoring, Memory usage
                  </div>
                </div>
                <div>
                  <div className="font-semibold text-purple-800 mb-1">
                  ...
                  <div className="text-purple-700 text-xs">
                    Load testing, Stress testing, Edge case validation
                  </div>
                </div>
                <div>
                  <div className="font-semibold text-purple-800 mb-1">
