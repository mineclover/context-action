...
const sampleData: SearchItem[] = [
  ...
  {
    id: '3',
    title: 'Context-Action Framework',
    category: 'Documentation',
    tags: ['context-action', 'react', 'state-management'],
    author: 'Dev Team',
    date: '2024-01-25',
  },
  {
  ...
  {
    id: '5',
    title: 'Action Pipeline Deep Dive',
    category: 'Tutorial',
    tags: ['context-action', 'pipeline', 'advanced'],
    author: 'Sarah Wilson',
    date: '2024-02-05',
  },
  {
    ...
    category: 'Guide',
    tags: ['store', 'patterns', 'architecture'],
    author: 'Tom Brown',
    date: '2024-02-10',
  },
  {
      ...
      <div className="page-container">
        <header className="page-header">
          ...
          <p className="page-description">
            ...
            실시간 검색, 필터링, 결과 선택을 통해 Store와 Action의 완벽한 검색
            시나리오를 보여줍니다.
          </p>
              ...
              <div className="flex flex-wrap gap-1">
                {stats.tags.slice(0, 10).map((tag) => (
                  <button
                    key={tag}
                    onClick={() =>
                      dispatch('addFilter', { key: 'tag', value: tag })
                    }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>
                  • <strong>searchQueryStore</strong>: 검색어 상태
                </li>
                <li>
                  • <strong>searchFiltersStore</strong>: 활성 필터 상태
                </li>
                <li>
                  • <strong>searchResultsStore</strong>: 검색 결과 목록
                </li>
                <li>
                  • <strong>selectedResultStore</strong>: 선택된 항목
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>
                  • <strong>performSearch</strong>: 검색 실행 및 필터링
                </li>
                <li>
                  • <strong>updateQuery</strong>: 검색어 업데이트
                </li>
                <li>
                  • <strong>addFilter/removeFilter</strong>: 필터 관리
                </li>
                <li>
                  • <strong>selectResult</strong>: 결과 선택
                </li>
              </ul>
            </div>
          </div>
