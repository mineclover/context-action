    ...
    <section className="bg-white rounded-2xl shadow-xl p-8">
      <div className="flex items-center gap-3 mb-6">
        <div className="p-3 bg-gradient-to-r from-orange-500 to-red-600 rounded-xl">
          <span className="w-8 h-8 text-white flex items-center justify-center text-2xl">
            🛡️
          </span>
        </div>
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            Advanced API Blocking System
          </h1>
          <p className="text-gray-600">
            API 요청 차단 및 중복 요청 방지 시스템
          </p>
        </div>
      </div>
          ...
          <div className="p-6 bg-gradient-to-r from-orange-50 to-red-50 rounded-xl">
            ...
            <div className="space-y-4 text-orange-800">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>Request Blocking:</strong> 중복 API 요청을 시간
                  기반으로 차단
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>Rate Limiting:</strong> 설정 가능한 요청 빈도 제한
                  시스템
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>Performance Metrics:</strong> 실시간 API 성능 및 차단
                  효율성 추적
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs text-gray-600">
                {rateLimit?.maxRequests || 5}회 /{' '}
                {(rateLimit?.windowMs || 10000) / 1000}초 (현재:{' '}
                {rateLimit?.requestsInWindow || 0}회)
              </div>
            </div>
          </div>
        </div>
      ...
      {isCurrentlyBlocked() && (
        <div className="p-4 bg-gradient-to-r from-yellow-50 to-orange-50 border border-orange-200 rounded-xl">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-sm text-orange-600">액션: {blockedAction}</div>
          </div>
          <div className="bg-orange-200 rounded-full h-3">
            <div
              ...
              style={{
                width: `${(remainingBlockTime / blockDuration) * 100}%`,
              }}
            />
          </div>
        </div>
          ...
          <div className="p-6 bg-gradient-to-r from-orange-50 to-red-50 rounded-xl">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-orange-900">
                  {Math.round(metrics?.blockingEfficiency || 0)}%
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-orange-700">현재 상태</span>
                <span
                  className={`font-bold ${isBlocked ? 'text-red-600' : 'text-green-600'}`}
                >
                  {isBlocked ? '차단 중' : '활성'}
                </span>
              </div>
          ...
          <div className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`font-bold ${
                    metrics?.currentLoadLevel === 'high'
                      ? 'text-red-600'
                      : metrics?.currentLoadLevel === 'medium'
                        ? 'text-yellow-600'
                        : 'text-green-600'
                  }`}
                >
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`font-bold ${rateLimit?.enabled ? 'text-green-600' : 'text-gray-400'}`}
                >
        ...
        <div className="space-y-6">
          <div className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-3 h-3 rounded-full ${rateLimit?.enabled ? 'bg-blue-500' : 'bg-gray-400'}`}
                />
                <span className="text-green-700">
                  Rate Limiting {rateLimit?.enabled ? '활성' : '비활성'}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div
                  className={`w-3 h-3 rounded-full ${isBlocked ? 'bg-red-500 animate-pulse' : 'bg-gray-400'}`}
                />
                <span className="text-green-700">
                  요청 차단 {isBlocked ? '중' : '대기'}
                </span>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${Math.min(100, metrics?.blockingEfficiency || 0)}%`,
                    }}
                  />
                </div>
              </div>
