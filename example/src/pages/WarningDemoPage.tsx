...
const WarningDemoPage: React.FC = () => {
  ...
  const [registry] = useState(
    () =>
      new ActionRegister<DemoActions>({
  ...
  const testTypeOnlyAction = async () => {
    addLog(
      'Testing type-only action (typeOnlyAction - no handler registered)...'
    );
    try {
    ...
    try {
      ...
      registry.register(
        ...
        (payload) => {
          ...
          addLog(
            `🎯 Handler executed: Counter increased to ${counter + 1} (payload: ${payload.value})`
          );
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            Warning Messages Demo
          </h1>
          <p className="mt-2 text-gray-600">
            Context-Action의 새로운 경고 메시지 기능을 테스트해보세요. 개발자
            도구의 콘솔을 열어서 경고 메시지를 확인하세요.
          </p>
        </div>
          ...
          <div className="flex items-center justify-center space-x-4">
            ...
            <div className="text-gray-600">
              ...
              <p className="text-xs text-gray-500">
                Each dispatch increments counter
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  "typeOnlyAction (핸들러 없음)" 버튼을 클릭하여 경고 메시지를
                  확인하세요.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  "핸들러 등록 (카운터 로직)" 버튼을 클릭하여 카운터 증가 로직을
                  등록하세요.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  핸들러 등록 후 "typeOnlyAction (핸들러 없음)" 버튼을 다시
                  클릭하면 카운터가 증가합니다.
                </p>
              </div>
            </div>
