...
function LayeredArchitectureFiles() {
  ...
  const filesByLayer = LAYER_STRUCTURE.map((layer) => {
    const files = layeredArchFiles.filter((file) =>
      layer.pathPattern.test(file.filePath)
    );
    return { ...layer, files };
  });

  // 분류되지 않은 파일들
  const uncategorizedFiles = layeredArchFiles.filter(
    (file) =>
      ...
      <div className="bg-gray-50 border rounded-lg p-4">
        <div className="text-sm text-gray-500 text-center">
          ...
          <span className="text-xs">
            Navigate through the example to see source file structure.
          </span>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-gray-600 mb-3">
        <strong>{layeredArchFiles.length}</strong> files currently registered
        from layered architecture pattern
      </div>
      ...
      {filesByLayer.map((layer) => (
        <div key={layer.name} className="border rounded-lg overflow-hidden">
          <div
            className={`bg-${layer.color}-50 border-${layer.color}-200 px-4 py-2 border-b`}
          >
            <div className="flex items-center gap-2">
              ...
              <div className="ml-auto">
                <span
                  className={`text-xs bg-${layer.color}-100 text-${layer.color}-700 px-2 py-1 rounded`}
                >
          ...
          {layer.files.length > 0 ? (
            <div className="bg-white">
              {layer.files.map((file) => (
                <div
                  key={file.filePath}
                  className="flex items-center gap-3 px-4 py-2 border-b border-gray-100 last:border-b-0 hover:bg-gray-50"
                >
        ...
        <div className="border rounded-lg overflow-hidden">
          <div className="bg-gray-50 px-4 py-2 border-b border-gray-200">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-medium text-gray-800">Other Files</div>
...
export default function LayeredArchitecturePage() {
  ...
  useRegisterSourceFile(
    'pages/patterns/layered-architecture/LayeredArchitecturePage.tsx',
    {
    ...
    <Container>
      <div className="space-y-8">
        <header className="text-center">
          <h1 className="text-3xl font-bold mb-4">Layered Architecture</h1>
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
                    <span>
                      Try duplicate email validation (Handler Injection)
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-blue-50 p-3 rounded-lg">
                    ...
                    <p className="text-blue-700">
                      ...
                      <br />
                      2. Try creating another user with the same email
                      <br />
                  ...
                  <div className="bg-green-50 p-3 rounded-lg">
                    ...
                    <p className="text-green-700">
                      Pure business logic + Latest values from stores = Perfect
                      validation
                    </p>
                  </div>
                </div>
        ...
        <section className="bg-gradient-to-r from-slate-50 to-gray-50 p-6 rounded-xl border border-slate-200">
          ...
          <p className="text-sm text-gray-600 mb-6">
            실제 구현된 파일들을 6-Layer 구조별로 분류하여 표시합니다. 각 파일은{' '}
            <a
            ...
            시스템에 의해 자동으로 등록되며, GitHub에서 실제 소스 코드를 확인할
            수 있습니다.
          </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3 p-2 rounded-md hover:bg-green-50 transition-colors">
                  ...
                  <div>
                    <strong className="text-gray-800">
                      Side effects are isolated in handlers
                    </strong>
                    <p className="text-sm text-gray-600 mt-1">
                ...
                <li className="flex items-start gap-3 p-2 rounded-md hover:bg-green-50 transition-colors">
                  ...
                  <div>
                    <strong className="text-gray-800">
                      Latest values through handler injection
                    </strong>
                    <p className="text-sm text-gray-600 mt-1">
                      Always access current state safely
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3 p-2 rounded-md hover:bg-green-50 transition-colors">
        ...
        <section className="bg-gray-50 p-6 rounded-lg">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span>
                <strong>User Interaction</strong> → View triggers action
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs">
              ...
              <span>
                <strong>Action Dispatch</strong> → Action layer calls handler
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs">
              ...
              <span>
                <strong>Handler Injection</strong> → Gets latest values from
                context
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span>
                <strong>Pure Business Logic</strong> → Executes domain logic
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs">
              ...
              <span>
                <strong>Side Effects</strong> → Handler updates stores
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs">
              ...
              <span>
                <strong>Reactive Update</strong> → Hook layer updates view
              </span>
            </div>
          </div>
        </section>
