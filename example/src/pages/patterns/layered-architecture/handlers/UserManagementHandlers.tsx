...
export function UserManagementHandlers({
  ...
  useRegisterSourceFile(
    'pages/patterns/layered-architecture/handlers/UserManagementHandlers.tsx',
    {
      name: 'UserManagementHandlers',
      description:
        'Handler logic with dependency injection for user management',
  ...
  const createUserHandler = useCallback(
    async (payload: { name: string; email: string; role: User['role'] }) => {
    ...
    [usersStore, operationStatusStore, apiClient, logger, onUserCreated]
  );
  ...
  const updateUserHandler = useCallback(
    ...
    [usersStore, operationStatusStore, apiClient, logger, onUserUpdated]
  );
  ...
  const deleteUserHandler = useCallback(
    ...
    [usersStore, operationStatusStore, apiClient, logger, onUserDeleted]
  );
