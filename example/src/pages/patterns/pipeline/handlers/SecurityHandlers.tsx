...
export function SecurityHandlers({ 
  ...
  const standardSecurityHandler = useCallback(async (payload: any, controller: any): Promise<void> => {
  ...
  const elevatedSecurityHandler = useCallback(async (payload: any, controller: any): Promise<void> => {
  ...
  useSecurityActionHandler('processRequest', standardSecurityHandler, { priority: 1000, blocking: true });
  useSecurityActionHandler('processRequest', elevatedSecurityHandler, { priority: 50, blocking: true });
