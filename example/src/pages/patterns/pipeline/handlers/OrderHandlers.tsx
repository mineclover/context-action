...
export function OrderHandlers({
  ...
  const businessRulesHandler = useCallback(
  ...
  const expeditedHandler = useCallback(
    async (payload: any, controller: any): Promise<void> => {
  ...
  const internationalHandler = useCallback(
    async (payload: any, controller: any): Promise<void> => {
  ...
  const premiumAfterHoursHandler = useCallback(
    async (payload: any, controller: any): Promise<void> => {
  ...
  const highValueHandler = useCallback(
    async (payload: any, controller: any): Promise<void> => {
  ...
  const standardHandler = useCallback(
    async (payload: any, controller: any): Promise<void> => {
  ...
  useOrderActionHandler('processOrder', businessRulesHandler, {
    priority: 100,
    blocking: true,
  });
  useOrderActionHandler('processOrder', expeditedHandler, {
    priority: 800,
    blocking: true,
  });
  useOrderActionHandler('processOrder', internationalHandler, {
    priority: 750,
    blocking: true,
  });
  useOrderActionHandler('processOrder', premiumAfterHoursHandler, {
    priority: 700,
    blocking: true,
  });
  useOrderActionHandler('processOrder', highValueHandler, {
    priority: 600,
    blocking: true,
  });
  useOrderActionHandler('processOrder', standardHandler, {
    priority: 50,
    blocking: true,
  });
