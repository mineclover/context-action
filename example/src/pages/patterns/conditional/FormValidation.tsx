...
const {
  ...
  useActionDispatch: useValidationAction,
  useActionHandler: useValidationHandler,
} = createActionContext<ValidationActions>('FormValidation');

const { Provider: FormStoreProvider, useStore: useFormStore } =
  createStoreContext('FormValidation', {
    formData: {
      initialValue: {
        email: '',
        password: '',
      ...
      <div className="mb-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
          <p className="text-sm text-blue-800">
            <strong>Conditional Validation:</strong> This pattern demonstrates
            how actions can conditionally execute based on validation results,
            with immediate feedback and state visualization.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div
                className={`p-3 rounded-md ${isValid ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}
              >
              ...
              <div
                className={`p-2 rounded text-sm ${isSubmitting ? 'bg-blue-50 text-blue-600' : 'bg-gray-50 text-gray-600'}`}
              >
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <ol className="text-sm text-gray-700 space-y-2">
              <li>
                ...
                <span className="ml-2">
                  Type in any field to trigger real-time validation
                </span>
              </li>
              <li>
                <span className="font-semibold text-yellow-600">2.</span>
                <span className="ml-2">
                  Action handlers conditionally validate based on field rules
                </span>
              </li>
              <li>
                <span className="font-semibold text-yellow-600">3.</span>
                <span className="ml-2">
                  Submit button is conditionally enabled only when form is valid
                </span>
              </li>
              <li>
                <span className="font-semibold text-yellow-600">4.</span>
                <span className="ml-2">
                  Submit action conditionally executes based on final validation
                </span>
              </li>
            </ol>
          </div>
