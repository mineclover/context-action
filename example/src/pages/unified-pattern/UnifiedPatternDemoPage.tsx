...
import { Card, CardContent, Badge, Button, Grid, HOCPatternBadge, ProviderPatternBadge } from '../../components/ui';
      ...
      <CardContent className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          <Button 
            size="sm" 
            variant="info" 
            onClick={() => dispatch('setCount', { value: Math.floor(Math.random() * 100) })}
          >
            🎲 Random
          </Button>
        </div>
...
function UnifiedPatternDemoPage() {
  return (
    <PageWithLogMonitor pageId="unified-pattern-demo" title="Unified Pattern Demo">
      <div className="page-container">
        <header className="page-header">
          <h1>Unified Context Pattern Demo</h1>
          <p className="page-description">
            Explore the new Unified Context Pattern that combines Store and Action management.
            See two different usage patterns: HOC (Higher-Order Component) and Provider patterns.
          </p>
        </header>
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">📋 Pattern Comparison</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-blue-50 rounded border border-blue-200">
                <h4 className="font-semibold text-blue-900 mb-3">🔧 HOC Pattern</h4>
              ...
              <div className="p-4 bg-purple-50 rounded border border-purple-200">
                <h4 className="font-semibold text-purple-900 mb-3">🏗️ Provider Pattern</h4>
...
<CounterWithProvider />`}
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Provider Pattern</h4>
                <pre className="bg-gray-900 text-gray-100 p-3 rounded text-xs overflow-x-auto">
