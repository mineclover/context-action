...
export function createLogger(
  prefixOrLevel: string | LogLevel = '[App]',
  level?: LogLevel
): Logger {
...
const createStyleHelpers = (theme: {
  primary: string;
  secondary: string;
  accent: string;
}) => ({
  title: (text: string) => {
    ...
    console.log(
      styledText,
      `font-size: 18px; font-weight: bold; color: ${theme.primary}`
    );
    return text;
  },
  subtitle: (text: string) => {
    ...
    console.log(
      styledText,
      `font-size: 14px; font-weight: bold; color: ${theme.secondary}`
    );
    return text;
  },
  info: (text: string) => {
  ...
  code: (text: string) => {
    ...
    console.log(
      styledText,
      'font-family: monospace; background: #f5f5f5; padding: 2px 4px; border-radius: 3px'
    );
    return text;
  },
  divider: () => {
...
export class ConsoleLogger {
  ...
  constructor(
    prefixOrLevel: string | LogLevel = '[Console]',
