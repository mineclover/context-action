...
**테스트 위치:** [`useStoreValue.usage.test.tsx`](https://github.com/mineclover/context-action/blob/main/packages/react/__tests__/stores/hooks/useStoreValue.usage.test.tsx) (줄 16)
