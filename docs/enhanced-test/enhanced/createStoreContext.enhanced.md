...
**테스트 위치:** [`createStoreContext.usage.test.tsx`](https://github.com/user/context-action/blob/main/packages/react/__tests__/stores/patterns/createStoreContext.usage.test.tsx) (줄 8)
