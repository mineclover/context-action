...
**테스트 위치:** [`createActionContext.usage.test.tsx`](https://github.com/user/context-action/blob/main/packages/react/__tests__/createActionContext.usage.test.tsx) (줄 8)
...
**테스트 위치:** [`createActionContext.usage.test.tsx`](https://github.com/user/context-action/blob/main/packages/react/__tests__/createActionContext.usage.test.tsx) (줄 101)
