...
- **워크스페이스 패키지 기준 버전**: `@context-action/core` 1.1.3, `@context-action/react` 3.0.0, `@context-action/tool-protocol` 1.0.2, `@context-action/tool-durable-operations` 0.2.0, `@context-action/ai-sdk` 0.1.0, `@context-action/webmcp` 0.1.2. 외부 설치에는 published dist-tag를 기준으로 사용합니다.
