...
**테스트 위치:** [`createActionContext.usage.test.tsx`](https://github.com/mineclover/context-action/blob/main/packages/react/__tests__/createActionContext.usage.test.tsx)
...
# 특정 API 검증
pnpm test:validate-docs --api=createActionContext
```

**관련 테스트 파일:**
- [`createActionContext.usage.test.tsx`](../../../packages/react/__tests__/createActionContext.usage.test.tsx)
- [`createActionContext.api.test.tsx`](../../../packages/react/__tests__/createActionContext.api.test.tsx)
