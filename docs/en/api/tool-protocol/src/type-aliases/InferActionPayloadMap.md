...
Defined in: [packages/tool-protocol/src/action-schema.ts:180](https://github.com/mineclover/context-action/blob/main/packages/tool-protocol/src/action-schema.ts#L180)
