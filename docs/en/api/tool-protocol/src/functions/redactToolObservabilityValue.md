...
Defined in: [packages/tool-protocol/src/observability.ts:175](https://github.com/mineclover/context-action/blob/main/packages/tool-protocol/src/observability.ts#L175)
