...
Defined in: [packages/tool-protocol/src/observability.ts:337](https://github.com/mineclover/context-action/blob/main/packages/tool-protocol/src/observability.ts#L337)
