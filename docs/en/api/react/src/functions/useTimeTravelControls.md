...
Defined in: [packages/react/src/stores/hooks/useTimeTravelControls.ts:65](https://github.com/mineclover/context-action/blob/main/packages/react/src/stores/hooks/useTimeTravelControls.ts#L65)
