...
Defined in: [packages/react/src/stores/patterns/store-definition.ts:24](https://github.com/mineclover/context-action/blob/main/packages/react/src/stores/patterns/store-definition.ts#L24)
