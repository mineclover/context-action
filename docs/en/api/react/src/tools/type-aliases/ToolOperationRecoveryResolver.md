...
Defined in: [packages/react/src/tools/ToolContext.types.ts:66](https://github.com/mineclover/context-action/blob/main/packages/react/src/tools/ToolContext.types.ts#L66)
