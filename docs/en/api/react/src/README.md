...
[context-action-monorepo](../../../README.md) / packages/react/src
...
- [StoreDefinitions](type-aliases/StoreDefinitions.md)
- [InferStoreTypes](type-aliases/InferStoreTypes.md)
- [InferInitialStores](type-aliases/InferInitialStores.md)
- [StoreValues](type-aliases/StoreValues.md)
- [ComparisonStrategy](type-aliases/ComparisonStrategy.md)
- [CustomComparator](type-aliases/CustomComparator.md)
...
- [useMultiComputedStore](functions/useMultiComputedStore.md)
- [useComputedStoreInstance](functions/useComputedStoreInstance.md)
- [useAsyncComputedStore](functions/useAsyncComputedStore.md)
- [useLocalStore](functions/useLocalStore.md)
- [usePersistedStore](functions/usePersistedStore.md)
- [defaultEqualityFn](functions/defaultEqualityFn.md)
- [shallowEqual](functions/shallowEqual.md)
- [deepEqual](functions/deepEqual.md)
- [useStoreSelector](functions/useStoreSelector.md)
- [useMultiStoreSelector](functions/useMultiStoreSelector.md)
- [useStorePathSelector](functions/useStorePathSelector.md)
...
- [getGlobalImmutabilityOptions](functions/getGlobalImmutabilityOptions.md)
- [performantSafeGet](functions/performantSafeGet.md)
- [createRegistrySync](functions/createRegistrySync.md)
...
Renames and re-exports [StoreConfig](interfaces/StoreConfig.md)
