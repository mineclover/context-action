...
- **Workspace package baseline**: `@context-action/core` 1.1.3, `@context-action/react` 3.0.0, `@context-action/tool-protocol` 1.0.2, `@context-action/tool-durable-operations` 0.2.0, `@context-action/ai-sdk` 0.1.0, and `@context-action/webmcp` 0.1.2. Published dist-tags remain authoritative for an external install.
