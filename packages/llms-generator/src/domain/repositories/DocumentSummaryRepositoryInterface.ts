/**
 * Domain Repository Interface: DocumentSummaryRepositoryInterface
 * 
 ...
 */
export interface DocumentSummaryRepositoryInterface {
  /**
   * 단일 문서 요약 저장
   */
   ...
   */
  findByCharacterLimit(characterLimit: CharacterLimit): Promise<ReadonlyArray<DocumentSummary>>;
