...
export class HelpDisplay {
  show(): void {
    ...
    console.log('  npx @context-action/llms-generator work-next --limit 10 --verbose  # Top 10 priority items');
    console.log('  npx @context-action/llms-generator work-next --top 5 --category guide  # Top 5 guide documents');
    console.log('');
    console.log('  # Priority management');
    console.log('  npx @context-action/llms-generator priority-stats');
    console.log('  npx @context-action/llms-generator priority-health');
    console.log('  npx @context-action/llms-generator priority-tasks --verbose');
    console.log('  npx @context-action/llms-generator priority-tasks --task-type missing --fix');
    console.log('');
    ...
    console.log('');
    console.log('🔧 PRIORITY TASK TYPES:');
    console.log('  🔴 missing      - priority.json files are missing');
    console.log('  ❌ invalid      - JSON syntax errors or missing required fields');
    console.log('  🟡 outdated     - source documents modified after priority.json');
    console.log('  🟠 needs_review - priority scores don\'t align with category standards');
    console.log('  🔵 needs_update - metadata is incomplete or needs enhancement');
    console.log('');
