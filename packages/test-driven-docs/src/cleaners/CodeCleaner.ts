import { CleanerOptions, ParsedTestData } from '../types/index.js';
...
export class CodeCleaner {
   ...
   */
  cleanCode(code: string, context: { category?: string } = {}): string {
    let cleaned = code;
   ...
   */
  private removeTestArtifacts(code: string): string {
    let cleaned = code;
   ...
   */
  private makeRealistic(code: string): string {
    let realistic = code;
   ...
   */
  private addHelpfulComments(code: string, context: { category?: string }): string {
    let commented = code;
   ...
   */
  createCompleteExample(testData: ParsedTestData): string {
   ...
   */
  private createMinimalExample(code: string): string {
   ...
   */
  private createInteractiveExample(code: string): string {
