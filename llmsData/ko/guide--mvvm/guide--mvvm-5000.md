...
- Store Only Pattern - Model Layer 구현
- Action Only Pattern - ViewModel Layer 구현  
- RefContext Pattern - Performance Layer 구현
- Domain Context Architecture - 멀티 도메인 앱의 대안.
