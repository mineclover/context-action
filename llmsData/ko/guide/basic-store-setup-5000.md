---
document_id: ko_guide_basic-store-setup
category: guide
source_path: ko/guide/patterns/setup/basic-store-setup.md
character_limit: 5000
last_update: '2025-08-30T10:45:59.672Z'
...
• **타입 안전성**: 리터럴 타입에는 `as const` 사용하고 적절한 배열 타이핑
• **초기값**: 모든 스토어에 합리적인 기본값 제공
...
• **프로바이더 순서**: 종속성에 따른 프로바이더 순서 (독립적 → 종속적)
• **구성**: 수동 중첩보다 `composeProviders` 선호
• **HOC 사용**: 컴포넌트 수준 프로바이더 래핑을 위해 HOC 패턴 사용