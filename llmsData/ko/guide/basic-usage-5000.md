---
document_id: ko_guide_basic-usage
category: guide
source_path: ko/guide/patterns/ref/basic-usage.md
character_limit: 5000
last_update: '2025-08-30T10:45:53.971Z'
...
• **하드웨어 가속**: GPU 가속 애니메이션을 위해 `translate3d()` 사용
• **React 리렌더링 방지**: DOM 조작을 React 렌더링 사이클 밖에서 유지
• **관심사 분리**: 비즈니스 로직을 위해 커스텀 훅 사용
• **타입 안전성**: 적절한 HTML 요소 타입으로 명확한 ref 타입 인터페이스 정의
• **성능 우선**: 편의성보다 60fps 성능 우선